...
type ReturnResult struct {
	...
	InvalidPrefixUpload                    Result `mapstructure:"invalid_prefix_upload"`
	...
	InvalidIDCard                          Result `mapstructure:"invalid_id_card"`
	DeviceIDDoesNotMatch                   Result `mapstructure:"device_id_does_not_match"`
	InvalidUsernameOrPassword              Result `mapstructure:"invalid_username_or_password"`
	UnableRequestSubmittedForApproval      Result `mapstructure:"unable_request_submitted_for_approval"`
	UnableSubmitApprovalDueBlacklistStatus Result `mapstructure:"unable_submit_approval_due_blacklist_status"`
	InformationNotYetApproved              Result `mapstructure:"information_not_yet_approved"`
	ApprovalHasBeenSubmitted               Result `mapstructure:"approval_has_been_submitted"`
	ItemsNotEnough                         Result `mapstructure:"items_not_enough"`
	TaxIdAlradyInSystem                    Result `mapstructure:"tax_id_alrady_in_system"`
	InsufficientBudget                     Result `mapstructure:"insufficient_budget"`
	Internal struct {
