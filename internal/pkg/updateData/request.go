...
type UpdateData struct {
	...
	Node_name_th    string `json:"node_name_th"  example:"new"`
	Node_name_en    string `json:"node_name_en"  example:"new"`
	Node_desc       string `json:"node_desc"  example:"new"`
	Node_url        string `json:"node_url"  example:"/test/newurl"`
	Node_ref_value  string `json:"node_ref_value"  example:"new"`
	Node_ref_value2 string `json:"node_ref_value2"  example:"new"`
	Node_sort       int    `json:"node_sort"  example:"1"`
	Node_status     int    `json:"node_status"  example:"1"`
	Log_status      string `json:"log_status"  example:"new"`
