...
// @Security ApiKeyAuth
// @Router /test/refreshTK [post]
func (ep *endpoint) RETK(c *fiber.Ctx) error {
	return handlers.ResponseObject(c, ep.service.refreshTK, &LoginRequest{})
}
