...
type AddInformationRequest struct {
	...
	Node_desc       string `json:"node_desc"  example:"desc"`
	Node_url        string `json:"node_url"  example:"/test/newurl"`
	Node_ref_value  string `json:"node_ref_value"  example:"value1"`
	Node_ref_value2 string `json:"node_ref_value2"  example:"value2"`
	Node_sort       int    `json:"node_sort"  example:"1"`
	Node_status     int    `json:"node_status"  example:"1"`
	Log_status      string `json:"log_status"  example:"a"`
